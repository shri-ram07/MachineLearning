...
"""#Finding Optimal value of k by cross validation
cr_val = []
for k in range(1,1000):
    knn = KNeighborsClassifier(n_neighbors=k)
    score = cross_val_score(knn,x,y , cv=100, scoring='accuracy')
    cr_val.append(score.mean())
print("Optimal value of k is : ",np.argmax(cr_val))   # argmax is used to find the index of maximum value in the array

Optimal value of k is :  34"""
"""#model selection
